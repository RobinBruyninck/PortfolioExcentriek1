        ...
        <div className="mt-10 grid gap-14 md:grid-cols-12 md:gap-12">
          ...
          <div className="md:col-span-8">
            ...
            >
              ...
              <button
                type="submit"
                className="mt-8 h-11 border border-[#f2f2ee] bg-[#f2f2ee] px-8 text-[12px] font-semibold uppercase tracking-[0.06em] text-[#0d0d0d] transition hover:bg-transparent hover:text-[#f2f2ee]"
              >
                EMAIL ME
              </button>
            </form>
